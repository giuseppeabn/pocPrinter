...
import com.dantsu.thermalprinter.async.SerialConnection;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void printTest() throws EscPosConnectionException, EscPosEncodingException, EscPosBarcodeException, EscPosParserException {

        // Object printer = ThermalPrinter("/dev/serial0", 19200);
        Log.d("btn", "1");
        SerialConnection serialConnection = new SerialConnection();
        serialConnection.connect();
        Log.d("btn", "2");

        float printerWidthMM = 0;
        int charPerLine = 0;
        EscPosPrinter printer = new EscPosPrinter(serialConnection, 203, printerWidthMM, charPerLine);
        Log.d("btn", "4");


        String txtvalue = "TEST";
        printer.printFormattedTextAndCut(txtvalue);
    }
